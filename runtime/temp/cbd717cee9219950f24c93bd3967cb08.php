<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:80:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/set/read.html";i:1513758947;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/layout.html";i:1512955052;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/header.html";i:1513754748;s:76:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/left.html";i:1513590085;s:76:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/menu.html";i:1513653508;s:85:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/custom-fields.html";i:1513736379;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/footer.html";i:1512955052;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url('/module_url'); ?>"><?php echo $data['module_name']; ?></a>
                    </li>
                    <li>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-body">
                                ...
                                <form role="form" enctype="multipart/form-data" action="<?php echo url($data['module_url'].'update_role_privs/'.$id); ?>" method="post">
                                    
<div class="row">
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): if(isset($field['type']) && $field['type']): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
                ...
                <?php endif; ?>
                    <div class="form-group">
                        ...
                        <?php if(isset($item[$key]) AND $item[$key] != ""): ?>
                            ...
                            <a href="<?php echo url($data['module_url'] . 'delete_image/' . $item['system_uid']); ?>" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i> Delete</a>
                    ...
                    <div class="checkbox">
                        <?php if(isset($field['label']) AND $field['label']): ?><span><?php echo $field['label']; ?></span><?php endif; foreach($field['default'] as $ov => $ol): ?>
                            <label>
                                <input type="<?php echo $field['type']; ?>" name="<?php echo $key; ?>[]"
                                    <?php if(isset($field['disabled']) AND $field['disabled']): ?>disabled="disabled"<?php endif; ?>
                                    value="<?php echo $ov; ?>" <?php if(((isset($item[$ov]) && $item[$ov] == $ol) || (isset($item[$key]) && $item[$key] == $ol))): ?>
                                    checked="checked" <?php endif; ?>> <?php echo $ol; ?>
                            </label>
                        <?php endforeach; if(isset($field['notes']) AND $field['notes']): ?><p class="help-block"><?php echo $field['notes']; ?></p><?php endif; ?>
                    </div>
            ...
            <?php break; default: endswitch; endif; endforeach; endif; else: echo "" ;endif; ?>
</div>
        ...
        $('input:checkbox').click(function () { 
            ...
            $(this).parent().siblings().children('input:checkbox').attr("checked",true);
            }); 
        });
        </script>
</section>
