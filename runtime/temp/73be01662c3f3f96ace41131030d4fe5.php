<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:81:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/set/index.html";i:1513742500;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/layout.html";i:1512955052;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/header.html";i:1513754748;s:76:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/left.html";i:1513590085;s:76:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/menu.html";i:1513653508;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/footer.html";i:1512955052;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            ...
                            <ul class="controls">
                                <li><a href="<?php echo url($data['module_url'].'create_role'); ?>"><i class="fa fa-plus mr-5"></i> 新增</a></li>
                            </ul>
                        </div>
                        <!-- /tile header -->
                                    ...
                                    <tbody>
                                        <?php if(($list)): foreach($list as $item): ?>
                                            <tr id="tr_<?php echo $item->id; ?>">
                                                ...
                                                <td class="expire_time"><?php echo $item->create_at; ?></td>
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].$item->id); ?>">
                                                        <i class="glyphicon glyphicon-edit icon-white"></i>
                                                        编辑
                                                    </a>
                                                    <a class="btn btn-danger" href="javascript:;"  onclick="if(confirm('确定要删除该角色吗')){ deleteData(<?php echo $item->id; ?>)}">
        ...
        function deleteData(id){
            var url = "<?php echo url($data['module_url'].'role_delete/'); ?>";
            url = url.replace('/.','/'+id+'.');
            $.ajax({
                type:"POST",
                url:url,
