<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/administrator/index.html";i:1513752770;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/layout.html";i:1512955052;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/header.html";i:1513754748;s:76:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/left.html";i:1513590085;s:76:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/menu.html";i:1513653508;s:78:"/Users/linsonggao/Sites/APP/admin/public/../application/admin/view/footer.html";i:1512955052;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(($list)): foreach($list as $item): ?>
                                            <tr id="tr_<?php echo $item->system_uid; ?>">
                                                <td><?php echo $item->system_uid; ?></td>
                                                <td><?php echo $item->username; ?></td>
                                                <td><?php echo $item->nickname; ?></td>
                                                <td><?php echo $item->mobile; ?></td>
                                                <td><?php echo $item->last_login_ip; ?></td>
                                                <td><?php echo $item->last_login_at; ?></td>
                                                <td class="expire_time"><?php echo $item->expire_time; ?></td>
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].$item->system_uid); ?>">
                                                        <i class="glyphicon glyphicon-edit icon-white"></i>
                                                        编辑
                                                    </a>
                                                    <a class="btn btn-warning" href="javascript:;"  onclick="if(confirm('确定使管理员账号过期吗')){ updateExpireTime(<?php echo $item->system_uid; ?>)}">
                                                        <i class="glyphicon glyphicon-time icon-white"></i>
                                                        使过期
                                                    </a>
                                                    <a class="btn btn-danger" href="javascript:;"  onclick="if(confirm('确定要删除该管理员账号吗')){ deleteData(<?php echo $item->system_uid; ?>)}">
        ...
        function deleteData(id){
            var url = "<?php echo url($data['module_url'].'delete/'); ?>";
            url = url.replace('/.','/'+id+'.');
            $.ajax({
                type:"POST",
                url:url,
        ...
        function updateExpireTime(id){
            var url = "<?php echo url($data['module_url'].'update_expire_time/'); ?>";
            url = url.replace('/.','/'+id+'.');
            $.ajax({
                type:"POST",
                url:url,
